    ...
    return (
      <div className={`page posts`}>
        <div className='instructions'>
          ...
          <ul>
            <li>CTF 101 - https://ctf101.org/</li>
            <li>CTF Field Guide - Field Guide by Trail of Bits</li>
            <li>CTF Resources - Start Guide maintained by community</li>
            <li>Damn Vulnerable Web Application - PHP/MySQL web application that is damn vulnerable</li>
            <li>How to Get Started in CTF - Short guideline for CTF beginners by Endgame</li>
            <li>LiveOverFlow - Video tutorials on Exploitation.</li>
            <li>Awesome CTF - https://github.com/apsdehal/awesome-ctf</li>
          </ul>
