    ...
    return (
      <div className={`page posts`}>
        <div className='instructions'>
          ...
          <div className='instruction-heading'>KernelTRON CTF Competition</div>
          <p>CTFs are competitions held in the cyber security community in which participants have to solve puzzles, 
          ...
          <p>The competition is scheduled is from 10am (CST), Friday, March 27th through 3pm (CST), Saturday, March 28th.</p>
          ...
          <p>Join us on discord in the <code>{`#kerneltron-ctf`}</code> channel or use the walk-up zoom meeting: <code>https://kernelcon.org/virtual/ctf</code></p>
